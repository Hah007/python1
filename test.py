...
class Programmer(Student):
    def __init__(self, name, job='programmer', time=0.00, time_effective=1.00):
        Student.__init__(self, name, job='programmer', time=0.00, time_effective=1.00)

    def count_time(self, hour, rate):
        self.time_effective =1
